...
| 「我上次日记里提到的那个面试怎么样了」 | 查 Base 对应记录，结合日记内容回复 |
| 「查一下我关于 XX 的感悟」 | 搜索 Base 关键词/灵感字段匹配 |
| 「帮我看看 6 月 1 号的日记」 | 按日期筛选，返回当天 Done List + 灵感 |
| 「最近日记的关键词有哪些」 | 拉取最近 N 条记录的关键词汇总 |

> **不需要每次说「整理日记」**——只要提到「日记」「Done List」「我记过」「之前日记」等词，AI 就会自动想起你的日记配置。
...
| 6.1 | 2026-06-01 | ✅ 参加XX课题组的组会<br>✅ 修改论文第三部分<br>… | 💡 开始做之后发现没想象中困难<br>💡 多输出内容时灵感更多<br>… | 论文, 组会, 自媒体 |
| 5.30 | 2026-05-30 | ✅ 出门和朋友逛街拍照<br>✅ 读完XX书前两章<br>… | 💡 每周出门社交是很好的充电<br>💡 做内容应先想文案再定形式<br>… | 社交, 阅读, 内容创作 |
